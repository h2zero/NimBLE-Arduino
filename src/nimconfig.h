...
#ifdef CONFIG_BT_NIMBLE_ROLE_CENTRAL // workaround
...
#ifdef CONFIG_BT_NIMBLE_ROLE_OBSERVER // workaround
...
#ifdef CONFIG_BT_NIMBLE_ROLE_PERIPHERAL // workaround
...
#ifdef CONFIG_BT_NIMBLE_ROLE_BROADCASTER// workaround
