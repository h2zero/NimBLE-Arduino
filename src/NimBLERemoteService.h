...
public:
    ...
    NimBLERemoteCharacteristic*               getCharacteristic(const char* uuid, uint8_t inst = 0);
    NimBLERemoteCharacteristic*               getCharacteristic(const NimBLEUUID &uuid, uint8_t inst = 0);
