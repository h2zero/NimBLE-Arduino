...
#include "nimble/porting/include/bt_osi_mem.h"
...
static int dummy_na_host_rcv_pkt(uint8_t *data, uint16_t len)
{
    /* Dummy function */
    return 0;
}
 ...
 */
static int na_host_rcv_pkt(uint8_t *data, uint16_t len)
{
