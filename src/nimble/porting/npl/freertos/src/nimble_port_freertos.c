...
#ifdef MYNEWT_VAL_NIMBLE_HOST_TASK_PRIORITY
# define NIMBLE_HOST_TASK_PRIORITY (MYNEWT_VAL(NIMBLE_HOST_TASK_PRIORITY))
#else
...
#ifdef MYNEWT_VAL_BLE_LL_TASK_PRIORITY
# define NIMBLE_LL_TASK_PRIORITY MYNEWT_VAL_BLE_LL_TASK_PRIORITY
#else
