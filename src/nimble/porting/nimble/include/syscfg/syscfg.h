...
// THESE NEED TO BE REMOVED WHEN CORE IS UPDATED
#define MYNEWT_VAL_NIMBLE_HOST_TASK_STACK_SIZE CONFIG_BT_NIMBLE_HOST_TASK_STACK_SIZE
//#define MYNEWT_VAL_NIMBLE_CONTROLLER_TASK_STACK_SIZE CONFIG_BT_NIMBLE_CONTROLLER_TASK_STACK_SIZE
