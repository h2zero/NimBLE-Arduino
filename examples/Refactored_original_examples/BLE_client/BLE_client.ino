...
bool connectToServer() {
    ...
    pClient->connect(myDevice); // if you pass BLEAdvertisedDevice instead of address, it will be recognized type of
                                // peer device address (public or private)
...
void loop() {
    ...
    if (connected) {
        ...
        BLEDevice::getScan()->start(0); // this is just eample to start scan after disconnect, most likely there is
