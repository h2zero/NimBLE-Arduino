/*
   ...
   ESP32 by Evandro Copercini updated by chegewara
...
void loop() {
    ...
    if (deviceConnected) {
        ...
        value++;
        delay(10); // bluetooth stack will go into congestion, if too many packets are sent, in 6 hours test i was able
                   // to go as low as 3ms
    }
    // disconnecting
